...
const TikTokIcon = ({ className, ...props }: { className?: string; [key: string]: unknown }) => (
  <svg viewBox="0 0 24 24" className={className} {...props}>
    <path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-2.88 2.5 2.89 2.89 0 0 1-2.88-2.88 2.89 2.89 0 0 1 2.88-2.88c.28 0 .56.04.82.11V9.03a6.37 6.37 0 0 0-.82-.05 6.28 6.28 0 0 0-6.28 6.28 6.28 6.28 0 0 0 6.28 6.28 6.28 6.28 0 0 0 6.28-6.28V8.69a8.16 8.16 0 0 0 3.82.94V6.26a4.84 4.84 0 0 1-3.82.43z" fill="#25F4EE" />
    <path d="M16.37 2h-3.45v13.67a2.89 2.89 0 0 1-2.88 2.5 2.89 2.89 0 0 1-1.69-.55 2.89 2.89 0 0 0 4.57-2.34V2h3.45z" fill="#FE2C55" />
    <path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-.45v.44a4.83 4.83 0 0 0 3.77 4.25 4.84 4.84 0 0 0 .45-.01z" fill="#FE2C55" />
  </svg>
)
